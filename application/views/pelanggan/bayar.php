                        ...
                        <div class="card-body shadow-lg">
                            <form action="tambah_pelanggan" method="POST">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="nama" name="nama" value="<?= isset($pelanggan['nama_pelanggan']) ? $pelanggan['nama_pelanggan'] : 'Nama pelanggan tidak ditemukan'; ?>" readonly>
